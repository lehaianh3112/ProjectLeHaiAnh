...
require_once('config/controller/sigController.php');
?>
<!doctype html>
<html lang="en">
                ...
                <div class="col-lg-7 px-5 pt-5">
                   ...
                   <div class="alert alert-danger">
                    ...
                    <div class="form-row col-lg-7">    
                            <input type="text" name="username" placeholder="Username" value="<?php echo $username; ?>" class="form-control my-3 p-3">
                    </div>
                    <div class="form-row col-lg-7">
